...
public class Client implements User{ // implementasi interface
    ...
    public Client(){ // contructor
        this.namaClient.add("Andini");
        this.alamat.add("Kediri");
        this.telepon.add("08982916070");
        this.saldo.add(100000);
        
        this.namaClient.add("Masyita");
    ...
    @Override // jika tidak ada akan error karena interface harus mengimplementasi semua abstract method
